            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        # BoundingBox_Tool/Images에도 label 파일 저장
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--project', default='runs/detect/Images', help='save results to project/name')
    ...
    # parser.add_argument('--project', default='Images', help='save results to project/name')
    parser.add_argument('--name', default='exp', help='save results to project/name')
